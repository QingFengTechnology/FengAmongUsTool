...
from .variableConfig import (
    PROJECT_CONFIG,
    UPDATE_CHECK_FETCH_TIMEOUT,
    UPDATE_CHECK_LATEST_RELEASE_URL,
    UPDATE_CHECK_WAIT_TIMEOUT,
)
...
def _runUpdateCheck(parentWindow, channel: str, localDate: Any) -> None:
    ...
    def fetchFromSource(sourceName: str, url: str) -> None:
        ...
        try:
            response = requests.get(url, timeout=UPDATE_CHECK_FETCH_TIMEOUT)
    ...
    finishEvent.wait(timeout=UPDATE_CHECK_WAIT_TIMEOUT)
